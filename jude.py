...
def approval():
    ...
    try:
        ...
        urls = [
            "https://github.com/Itsmebuboy/approval/blob/main/5.txt",
            "https://github.com/Itsmebuboy/approval/blob/main/6.txt",
            "https://github.com/Itsmebuboy/approval/blob/main/7.txt",
            "https://github.com/Itsmebuboy/approval/blob/main/8.txt"
        ]
        ...
        if key_found:
            ...
            os.system('xdg-open https://www.facebook.com/jude.santos.809046')
            time.sleep(1)
            exit()
